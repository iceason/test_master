  ...
  testing: {
    ...
    plans: {
      ...
      fields: {
        ...
        repeatRunTimesRange: '重复执行次数必须在 1 到 20 之间',
        repeatFailurePolicy: '重复执行失败策略',
      },
      repeatFailurePolicy: {
        continue_all: '继续全部轮次',
      ...
      detail: {
        ...
        downloadFailed: '下载失败',
        runConfig: '执行配置',
        execHistoryTotal: '累计执行',
        pushConfig: '推送配置',
        pushConfigNone: '未启用邮件、Webhook 或钉钉推送',
        pushEmailOn: '邮件：已启用，收件人 {count} 人',
        pushEmailEmpty: '邮件：已启用，但未填写收件人',
        pushWebhookOn: 'Webhook：已启用（{type}）',
        pushWebhookNoUrl: 'Webhook：已启用，但未填写地址',
        pushDingtalkOn: '钉钉：已启用，已选 {count} 个群组',
        pushDingtalkNoGroup: '钉钉：已启用，但未选择群组',
      },
      tableHeaders: {
        status: '状态',
        triggerType: '触发方式',
    ...
    notification: {
      ...
      emailRecipients: '收件人',
      webhook: 'Webhook 通知',
      webhookLegacyHint: '兼容模式（推荐迁移到下方钉钉群组配置）',
