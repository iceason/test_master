  ...
  testing: {
    ...
    plans: {
      ...
      detail: {
        ...
        execHistoryTotal: 'Total runs',
        pushConfig: 'Notifications',
        pushConfigNone: 'No email, webhook, or DingTalk notifications enabled',
        pushEmailOn: 'Email: on, {count} recipient(s)',
        pushEmailEmpty: 'Email: on, but no recipients',
        pushWebhookOn: 'Webhook: on ({type})',
        pushWebhookNoUrl: 'Webhook: on, but URL is empty',
        pushDingtalkOn: 'DingTalk: on, {count} group(s)',
        pushDingtalkNoGroup: 'DingTalk: on, but no group selected',
      },
      tableHeaders: {
        status: 'Status',
